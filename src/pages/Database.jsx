    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400">Perform destructive operations on the system database.</p>
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 flex flex-col">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg font-semibold text-slate-800 dark:text-white">Clear Recent Activity</h2>
          </div>
          ...
          <button
            ...
            disabled={isClearing}
            className="w-full flex items-center justify-center gap-2 bg-amber-50 text-amber-600 hover:bg-amber-100 dark:bg-amber-500/10 dark:text-amber-400 dark:hover:bg-amber-500/20 py-2.5 rounded-xl font-medium transition-colors cursor-pointer disabled:opacity-50"
          >
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-red-200 dark:border-red-900/30 p-6 flex flex-col relative overflow-hidden">
          ...
          <div className="flex items-center gap-3 mb-4 relative z-10">
            ...
            <h2 className="text-lg font-semibold text-red-600 dark:text-red-400">Wipe Database</h2>
          </div>
          <p className="text-slate-600 dark:text-slate-400 text-sm mb-6 flex-1 relative z-10">
          ...
          <button
            ...
            className="relative z-10 w-full flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white py-2.5 rounded-xl font-medium transition-colors cursor-pointer disabled:opacity-50"
          >
